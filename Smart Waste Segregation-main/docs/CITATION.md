...
**Primary Source**: [TrashBox GitHub Repository](https://github.com/nikhilvenkatkumsetty/TrashBox)
...
The TrashBox dataset is used under its original license terms. Please refer to the [TrashBox repository](https://github.com/nikhilvenkatkumsetty/TrashBox) for dataset licensing information.
